...
template <typename T> class co_generator;
...
template <typename T> class [[nodiscard]] co_generator {
public:
  ...
  public:
    ...
    void operator++(int) noexcept { (void)operator++(); }
  ...
  co_generator() noexcept : m_coroutine{nullptr} {}

  co_generator(co_generator &&other) noexcept : m_coroutine{other.m_coroutine} {
